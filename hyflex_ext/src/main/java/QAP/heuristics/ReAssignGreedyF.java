...
public class ReAssignGreedyF extends RuinRecreateHeuristic<SolutionQAP, InfoQAP> {
  ...
  public SolutionQAP apply(SolutionQAP c) {
    ...
    c.reAssignGreedyFFraction(this.params.getIOM((ParameterUsage)this));
    return c;
  }
...
/* Location:              C:\Users\Steve\Documents\GitHub\hyflext\domains\hyflex_ext.jar!\QAP\heuristics\ReAssignGreedyF.class
